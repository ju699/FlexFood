    ...
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      <style jsx>{`
        ...
        * {
        ...
        .nav-item.active {
          background: linear-gradient(90deg, rgba(255, 107, 107, 0.15) 0%, rgba(255, 154, 0, 0.1) 100%);
          border-left: 3px solid;
          border-image: linear-gradient(to bottom, #ff6b6b, #ff9a00) 1;
        }
      ...
      <div className="noise hidden dark:block"></div>

      <div className="min-h-screen grid grid-cols-1 md:grid-cols-[280px_1fr] relative z-10">
        {/* Sidebar */}
        <aside className="sidebar hidden md:flex flex-col">
              ...
              <Link
                ...
                className={`nav-item flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium ${
                  isActive(item.href)
                    ...
                    : 'text-gray-500 hover:text-foreground dark:text-gray-400 dark:hover:text-white'
                }`}
              >
                {item.icon}
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800">
            <div className="user-badge rounded-xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 rounded-full flex items-center justify-center">
              ...
              <Link href="/logout" className="block">
                <Button 
                  variant="primary"
                  className="w-full bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white text-sm font-medium shadow-lg shadow-red-500/20"
                >
        ...
        <div className="md:hidden sticky top-0 z-50 bg-background backdrop-blur-lg border-b p-4" style={{ borderColor: "var(--border-color)" }}>
          <div className="flex items-center justify-between">
            ...
            <Link href="/logout">
              <Button 
                variant="primary"
                className="bg-gradient-to-r from-red-500 to-orange-600 hover:from-red-600 hover:to-orange-700 text-white text-sm"
              >
