      ...
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400">Analysez les performances de votre menu</p>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-xl">
            <svg className="w-4 h-4 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
            </svg>
            <span className="text-sm text-blue-400">Données en temps réel</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Total Plats */}
          <div className="stat-card gradient-border rounded-2xl p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/5">
            ...
            <div className="text-gray-400 text-sm font-medium mb-1">Total Plats</div>
            <div className="text-4xl font-bold text-white">{stats.productsCount}</div>
          </div>

          {/* Catégories */}
          <div className="stat-card gradient-border rounded-2xl p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/5">
            <div className="flex items-start justify-between mb-4">
            ...
            <div className="text-gray-400 text-sm font-medium mb-1">Catégories</div>
            <div className="text-4xl font-bold text-white">{stats.categoriesCount}</div>
          </div>

          {/* En ligne */}
          <div className="stat-card gradient-border rounded-2xl p-6 bg-gradient-to-br from-green-500/10 to-green-600/5">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="px-2 py-1 bg-green-500/10 rounded-lg">
                <span className="text-xs font-medium text-green-400">Actifs</span>
              </div>
            </div>
            <div className="text-gray-400 text-sm font-medium mb-1">Disponibles</div>
            <div className="text-4xl font-bold text-green-400">{stats.availableCount}</div>
          </div>

          {/* Rupture */}
          <div className="stat-card gradient-border rounded-2xl p-6 bg-gradient-to-br from-red-500/10 to-red-600/5">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="px-2 py-1 bg-red-500/10 rounded-lg">
                <span className="text-xs font-medium text-red-400">Inactifs</span>
              </div>
            </div>
            <div className="text-gray-400 text-sm font-medium mb-1">En rupture</div>
            <div className="text-4xl font-bold text-red-400">{stats.unavailableCount}</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Pie Chart */}
          <div className="chart-card gradient-border rounded-2xl p-6" style={{ height: '400px' }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-green-500/20 to-red-500/20 rounded-xl flex items-center justify-center">
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white">Disponibilité des plats</h3>
            </div>
          ...
          <div className="chart-card gradient-border rounded-2xl p-6" style={{ height: '400px' }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Plats par catégorie</h3>
            </div>
            <ResponsiveContainer width="100%" height="85%">
              ...
              <div className="flex items-start gap-3 p-4 bg-green-500/5 border border-green-500/20 rounded-xl">
                ...
                <div>
                  <p className="text-sm text-gray-300 mb-1">
                    <span className="font-semibold text-white">{Math.round((stats.availableCount / stats.productsCount) * 100)}%</span> de vos plats sont disponibles
                  </p>
